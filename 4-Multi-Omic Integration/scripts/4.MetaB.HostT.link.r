...
# output:
# "4_MetaB.HostT.modules.linked.txt" stored in the "Output" directory
...
write.table(links, file = paste(output.dir,"/4_MetaB.HostT.modules.linked.txt",sep = ""), sep = "\t", quote = F, row.names = F)
