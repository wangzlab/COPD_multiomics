# files required:
# 1) "3_MetaG.MetaB.modules.linked.txt":  resulting data generated from script "7.MetaG.MetaB.link.r"
...
module.pairs = fread("MetaG.MetaB.modules.linked.txt", select = 1, data.table = F) %>% 
...
write.table(final_res, file = "5_LOSO_delta.spearman.r.txt", sep = "\t", quote = F, row.names = F)
