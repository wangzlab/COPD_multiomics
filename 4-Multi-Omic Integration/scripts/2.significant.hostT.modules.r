...
# 1) Transcriptomic feature abundance (1_hostT.module_eigengene.txt): An abundance table with genes in rows and samples in columns.
...
save(HostT.sigMods, file = "2_significant_hostT_modules.RData")