...
Output: 4_MetaG.MetaB.modules.linked.txt (linked MetaG-MetaB modules and the MetaG and MetaB features that link the two modules)
```
...
Output: 4_MetaB.HostT.modules.linked.txt (linked MetaB-HostT modules and the MetaB and HostT features that link the two modules)
```
...
Output: 4_HostT.module_HostP.protein.linked.txt (linked MetaB-HostT modules and the gene/protein ID that links the two modules)
```
